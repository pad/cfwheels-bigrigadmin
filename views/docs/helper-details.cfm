<div class="<cfoutput>#bigrigHelperFunction#</cfoutput> docs">
<p>This is a general overview of what the <code><cfoutput>#bigrigHelperFunction#</cfoutput>()</code> funtion does, and how to add your own, custom BigRig routes.</p>
<h2>Examples</h2>
...
<h2>Name, path, empty string keyword <code>(/blog/users/add/5)</code></h2>
<p>Skips the need for refrencing the BigRig folder in your routes.</p>
<h3><a href="#details"><code>&lt;cfset <cfoutput>#bigrigHelperFunction#</cfoutput>(name="apps", path="apps", keyword="") /></code></a></h3>
<div class="details">
...
<h3><a href="#details"><code>&lt;cfset <cfoutput>#bigrigHelperFunction#</cfoutput>(name="apps", path="apps", keyword="my-apps") /></code></a></h3>
